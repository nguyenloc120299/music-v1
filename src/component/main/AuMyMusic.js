...
const AuMysic = () => {
    ...
    const nhacTre = context.nhac.nhacAuMy[0][index]
        ...
        <div className='page-music'>
            <div className='title'>
                ...
                <select title='Thể loại' onChange={handleOnchane}>
                    ...
                    <option value={1}>Elelctronica/Dance</option>
                    <option value={2}>HipHop/Rap</option>
                    <option value={3}>Blues/Jazz</option>
